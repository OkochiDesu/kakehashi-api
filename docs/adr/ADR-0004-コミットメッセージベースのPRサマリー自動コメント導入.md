...
注: 決定4（コメント投稿方式）は [ADR-0005](ADR-0005-PR本文への変更内容自動反映方式への変更.md) によりPR本文への直接反映方式に置き換えられた。決定1〜3は引き続き有効。
...
- Supersedes: なし
- Superseded by: [ADR-0005](ADR-0005-PR本文への変更内容自動反映方式への変更.md)（決定4「コメント投稿方式」のみ）
