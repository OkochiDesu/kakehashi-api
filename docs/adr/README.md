...
| [APP-ADR-0011](APP-ADR-0011-Testcontainersコアを1.20.4に固定しSpringBoot4xのBOM管理2xを回避.md) | Testcontainers コアを 1.20.4 に固定し Spring Boot 4.x の BOM 管理（2.x）を回避 | コーディング | Accepted |
