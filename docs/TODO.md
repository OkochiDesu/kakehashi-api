...
- [Platform / DevEx](#platform--devex)
  - [コーディング規約](#コーディング規約) / [CI 設計課題](#ci-設計課題) / [CI パフォーマンス](#ci-パフォーマンス) / [Copilot 活用](#copilot-活用) / [AI駆動ドキュメンテーション](#ai駆動ドキュメンテーションナレッジ管理) / [MCPサーバー](#mcpサーバーブラウザ経由の外部urlアクセス) / [サンドボックス環境](#サンドボックス環境)
- [Frontend](#frontend)
